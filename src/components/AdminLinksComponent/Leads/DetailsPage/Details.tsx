                    ...
                    <div className="dashboardMyStreamsSection">
                        <div className="d-flex w-100 flex-wrap">
                            <ul className="breadcrumbs d-flex w-100">
                                ...
                                <li><Link to={"/dashboard/" + route + "s"}>{route === "lead" ? "Лиды" : "Заявки" }</Link></li>
                                <li><Link to={"/dashboard/" + route + "s/" + id}>{id}</Link></li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div className="row">
                            <div className="col-md-9">
                                <div className="details-lead p-3">
                                    <div className='details-title'>{route === "lead" ? "Лид" : "Заявка" } {id}
